...
export class CloudsPass extends Pass {
  ...
  constructor(options: CloudsPassOptions) {
    ...
    this.material = new ShaderMaterial({
      ...
      uniforms: {
        ...
        stepGrowthScale: {
          value: stepGrowthScale(
            options.quality.cloudMaxSteps,
            options.quality.cloudMaxDistance,
          ),
        },
        maxMarchDistance: { value: options.quality.cloudMaxDistance },
  ...
  setQuality(quality: QualitySettings): void {
    ...
    this.material.uniforms['stepGrowthScale']!.value = stepGrowthScale(
      quality.cloudMaxSteps,
      quality.cloudMaxDistance,
    )
    this.material.uniforms['maxMarchDistance']!.value = quality.cloudMaxDistance
