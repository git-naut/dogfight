...
export interface ReplayScript {
  ...
  /**
   * 空母の位置と艦首の向き。省略すると出さない。
   *
   * **既定で出さない。**基準画像 42 枚のうち 38 枚は空母の無い海を撮って
   * あるので、全部の台本に置くとその 38 枚が差分を出す。
   *
   * `heading` は 0 で艦首が −Z（自機の機首方向）を向く。位置は自機の
   * スポーン地点からの相対ではなく世界座標。**空母は動かないものなので、
